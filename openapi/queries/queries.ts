...
export const useApiServiceGetApiV1Datasets = <TData = Common.ApiServiceGetApiV1DatasetsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ page }: {
  page?: number;
} = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseApiServiceGetApiV1DatasetsKeyFn({ page }, queryKey), queryFn: () => ApiService.getApiV1Datasets({ page }) as TData, ...options });
