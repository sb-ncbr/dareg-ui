...
export const prefetchUseApiServiceGetApiV1Datasets = (queryClient: QueryClient, { page, project }: {
  page?: number;
  project?: string;
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseApiServiceGetApiV1DatasetsKeyFn({ page, project }), queryFn: () => ApiService.getApiV1Datasets({ page, project }) });
